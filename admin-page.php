...
function nnl_create_menu() {
    add_menu_page('Naughty & Nice', 'Naughty & Nice', 'manage_options', 'naughty-nice-list', 'nnl_admin_html', 'dashicons-forms');
}
...
function nnl_admin_html() {
    ...
    <div class="wrap">
        ...
        <div style="display: flex; gap: 20px; flex-wrap: wrap; margin-bottom: 20px;">
            <div style="flex: 1; min-width: 300px; background: #fff; padding: 20px; border-radius: 8px; border: 1px solid #ccd0d4;">
            ...
            <div style="flex: 1; min-width: 300px; background: #fff; padding: 20px; border-radius: 8px; border: 1px solid #ccd0d4;">
                ...
                <div style="background: #fbeaea; padding: 15px; border: 1px solid #dc3232; border-radius: 5px; margin-top: 20px;">
                    ...
                    <p>This will delete <strong>every name</strong> on the list. This cannot be undone.</p>
                    <form method="POST" onsubmit="return confirm('🚨 DANGER: Are you absolutely sure you want to PURGE THE ENTIRE LIST? This cannot be undone!');">
